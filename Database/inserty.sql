...
INSERT INTO KodyPocztowe_Miejscowosci (KodPocztowy, Miejscowosc) VALUES
('00-001', 'Warszawa'),
('30-001', 'Krakow'),
('90-001', 'Lodz'),
('80-001', 'Gdansk'),
...
INSERT INTO Uzytkownicy (Login, HasloHash, Imie, Nazwisko, MiejscowoscKodID, NumerPosesji, PESEL, DataUrodzenia, Plec, Email, Telefon)
VALUES
...
SELECT u.ID, p.ID FROM Uzytkownicy u, Uprawnienia p WHERE u.Login = 'admin'          AND p.Nazwa = 'Administrator' UNION ALL
...
-- gatunki i autorzy
INSERT INTO Gatunki (Nazwa) VALUES ('Fantastyka'), ('Kryminal'), ('Literatura faktu'), ('Klasyka');
GO
INSERT INTO Autorzy (Imie, Nazwisko) VALUES ('Andrzej', 'Sapkowski'), ('Stephen', 'King'), ('Adam', 'Mickiewicz');
GO

-- wydawnictwa
INSERT INTO Wydawnictwa (Nazwa) VALUES ('SuperNova'), ('PWN');
GO

-- katalog ksiazek
INSERT INTO KatalogKsiazek (Tytul, GatunekID, LiczbaStron, WydawnictwoID, RokWydania, Cena, Opis)
VALUES
('Wiedzmin: Ostatnie Zyczenie', (SELECT ID FROM Gatunki WHERE Nazwa='Fantastyka'), 320, (SELECT ID FROM Wydawnictwa WHERE Nazwa='SuperNova'), 1993, 39.99, 'Zbior opowiadan o wiedzminie Geralcie.'),
('Pan Tadeusz',                  (SELECT ID FROM Gatunki WHERE Nazwa='Klasyka'),    450, (SELECT ID FROM Wydawnictwa WHERE Nazwa='PWN'),       1834, 25.00, 'Epopeja narodowa.');
GO

-- powiazanie autorow z ksiazkami
INSERT INTO KsiazkKatalog_Autorzy (KsiazkaID, AutorID)
SELECT k.ID, a.ID FROM KatalogKsiazek k, Autorzy a WHERE k.Tytul = 'Wiedzmin: Ostatnie Zyczenie' AND a.Nazwisko = 'Sapkowski'  UNION ALL
